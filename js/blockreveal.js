$(function () {
    // .text, .text1, .text2 클래스를 가진 요소들을 배열로 가져옵니다.
    var elements = $(".text, .text1, .text2").toArray();
    ...
    $(window).scroll(function () {
        ...
        elements.forEach(function (item) {
            var itemOffset = $(item).offset().top - 600; // 각 요소의 상단 위치를 계산합니다.

            //나타나는 타이밍 수정시 요기 숫자 수정!!(600)
